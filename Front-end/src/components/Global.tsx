...
export function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto bg-black relative w-full">
      <div className="max-w-7xl mx-auto bg-black w-full relative overflow-hidden h-full md:h-[70rem] px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
        ...
        >
          <div className="text-center text-base pt-0 text-white text-[46px]  max-w-[600px] mt-2 mx-auto">
            <GlobTextStyle />
          </div>
        </motion.div>
        ...
        <div className="absolute w-full -bottom-10 h-96 md:h-[60rem] z-10 py-10">
